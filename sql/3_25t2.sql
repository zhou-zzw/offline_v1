...
-- 1运单表order_info、
DROP TABLE IF EXISTS tms.ods_order_info;
CREATE EXTERNAL TABLE tms.ods_order_info (
...
-- 2运单明细表order_cargo、
DROP TABLE IF EXISTS tms.ods_order_cargo;
CREATE EXTERNAL TABLE tms.ods_order_cargo (
    `id`            BIGINT,
...
-- 3字典表base_dic、
DROP TABLE IF EXISTS tms.ods_base_dic;
CREATE EXTERNAL TABLE tms.ods_base_dic (
    `id`          BIGINT COMMENT 'id',
...
-- 4小区表base_complex、
DROP TABLE IF EXISTS tms.ods_base_complex;
CREATE EXTERNAL TABLE tms.ods_base_complex
(
    `id`            BIGINT,
    `complex_name`  STRING,
    `province_id`   BIGINT,
...
DROP TABLE IF EXISTS tms.ods_base_region_info;
CREATE EXTERNAL TABLE tms.ods_base_region_info
(
    `id`          BIGINT COMMENT 'id',
    `parent_id`   BIGINT COMMENT '上级id',
    `name`        STRING COMMENT '名称',
...
-- 6机构表base_organ
DROP TABLE IF EXISTS tms.ods_base_organ;
CREATE EXTERNAL TABLE tms.ods_base_organ
(
    `id`            BIGINT,
...
*/
-- 1运单表order_info、
LOAD DATA INPATH '/2207A/zhengwei_zhou/tms/order_info/2024-09-09' INTO TABLE tms.ods_order_info PARTITION (dt = '2025-03-24') ;

-- 2运单明细表order_cargo、
LOAD DATA INPATH '/2207A/zhengwei_zhou/tms/order_cargo/2024-09-09' INTO TABLE tms.ods_order_cargo PARTITION (dt = '2025-03-24') ;

-- 3字典表base_dic、
LOAD DATA INPATH '/2207A/zhengwei_zhou/tms/base_dic/2024-09-09' INTO TABLE tms.ods_base_dic PARTITION (dt = '2025-03-24') ;

-- 4小区表base_complex、
LOAD DATA INPATH '/2207A/zhengwei_zhou/tms/base_complex/2024-09-08' INTO TABLE tms.ods_base_complex PARTITION (dt = '2025-03-24') ;

-- 5地区表base_region_info、
LOAD DATA INPATH '/2207A/zhengwei_zhou/tms/base_region_info/2024-09-08' INTO TABLE tms.ods_base_region_info PARTITION (dt = '2025-03-24') ;

-- 6机构表base_organ
LOAD DATA INPATH '/2207A/zhengwei_zhou/tms/base_organ/2024-09-08' INTO TABLE tms.ods_base_organ PARTITION (dt = '2025-03-24') ;
